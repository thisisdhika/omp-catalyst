...
export const AGENT_DESCRIPTIONS = {
  ...
  "worker-basic.md": "Simple, well-defined, single-file implementation",
  "worker-expert.md": "Complex multi-file implementation, refactoring, nuanced domain work",
  "worker-hyper.md": "Mission-critical, high-stakes, or coordination-heavy implementation",
